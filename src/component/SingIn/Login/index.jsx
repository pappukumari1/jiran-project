      ...
      <Box className="border rounded p-4 bg-shadow" sx={{ flexGrow: 1 }}>
        <Grid container className="d-flex flex-column gap-4  p-3 " spacing={2}>
          ...
          <Grid xs={12} className="text-center ">
            <button class="  rounded-pill py-2 px-5 btn1 w-100">
              {" "}
